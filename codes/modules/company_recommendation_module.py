from DATA.posting_data import companies
from modules.utils import count_matching_elements
from DATA.recommend_projects import recommend_projects
from DATA.skill_list import skill_stack
...
def calculate_matching_score(required_skills, user_skills):
    matching_count = count_matching_elements(required_skills, user_skills)
    total_skills = len(required_skills)
    matching_score = (matching_count / total_skills) * 100
    return f"{matching_score:.2f}%"
